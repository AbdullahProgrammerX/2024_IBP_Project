...
const Plugins = [
  // jQuery
  {
    from: 'node_modules/jquery/admin',
    to: 'plugins/jquery'
  },
  // Popper
  {
    from: 'node_modules/popper.js/admin',
    to: 'plugins/popper'
  },
  // Bootstrap
  {
    from: 'node_modules/bootstrap/admin/js',
  ...
  // Chart.js
  {
    from: 'node_modules/chart.js/admin/',
    to: 'plugins/chart.js'
  },
  // jQuery UI
  {
    from: 'node_modules/jquery-ui-admin/',
    to: 'plugins/jquery-ui'
  },
  // Flot
  {
    from: 'node_modules/flot/admin/es5/',
    to: 'plugins/flot'
  },
  {
  ...
  // Summernote
  {
    from: 'node_modules/summernote/admin/',
    to: 'plugins/summernote'
  },
  // Bootstrap Slider
  {
    from: 'node_modules/bootstrap-slider/admin/',
    to: 'plugins/bootstrap-slider'
  },
  {
    from: 'node_modules/bootstrap-slider/admin/css',
    to: 'plugins/bootstrap-slider/css'
  },
  // Bootstrap Colorpicker
  {
    from: 'node_modules/bootstrap-colorpicker/admin/js',
    to: 'plugins/bootstrap-colorpicker/js'
  },
  {
    from: 'node_modules/bootstrap-colorpicker/admin/css',
  ...
  // inputmask
  {
    from: 'node_modules/inputmask/admin/',
  ...
  {
    from: 'node_modules/jqvmap-novulnerability/admin/',
    to: 'plugins/jqvmap'
  },
  // jQuery Mapael
  {
  ...
  // jQuery Knob
  {
    from: 'node_modules/jquery-knob-chif/admin/',
    to: 'plugins/jquery-knob'
  },
  // pace-progress
  {
    from: 'node_modules/@lgaitan/pace-progress/admin/',
    to: 'plugins/pace-progress'
  },
  // Select2
  {
    from: 'node_modules/select2/admin/',
    to: 'plugins/select2'
  },
  {
    from: 'node_modules/@ttskch/select2-bootstrap4-theme/admin/',
  ...
  // SweetAlert2
  {
    from: 'node_modules/sweetalert2/admin/',
  ...
  // jsGrid
  {
    from: 'node_modules/jsgrid/admin',
    to: 'plugins/jsgrid'
  },
  {
  ...
  {
    from: 'node_modules/bootstrap4-duallistbox/admin',
    to: 'plugins/bootstrap4-duallistbox/'
  },
  // filterizr
  {
    from: 'node_modules/filterizr/admin',
    to: 'plugins/filterizr/'
  },
  // ekko-lightbox
  {
    from: 'node_modules/ekko-lightbox/admin',
    to: 'plugins/ekko-lightbox/'
  },
  // bootstrap-switch
  {
    from: 'node_modules/bootstrap-switch/admin',
    to: 'plugins/bootstrap-switch/'
  },
  // jQuery Validate
  {
    from: 'node_modules/jquery-validation/admin/',
    to: 'plugins/jquery-validation'
  },
  // bs-custom-file-input
  {
    from: 'node_modules/bs-custom-file-input/admin/',
    to: 'plugins/bs-custom-file-input'
  },
  // bs-stepper
  {
    from: 'node_modules/bs-stepper/admin/',
  ...
  // dropzonejs
  {
    from: 'node_modules/dropzone/admin/',
    to: 'plugins/dropzone'
  },
  // uPlot
  {
    from: 'node_modules/uplot/admin/',
    to: 'plugins/uplot'
  }
]
